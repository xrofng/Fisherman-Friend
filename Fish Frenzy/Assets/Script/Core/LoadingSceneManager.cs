...
public class LoadingSceneManager : MonoBehaviour
{
    ...
    {
        //Time.timeScale = 1f;
        LoadingProgressBar.GetComponent<Image>().fillAmount += Time.deltaTime * ProgressBarSpeed;
        LoadingProgressBar.GetComponent<Image>().fillAmount = Mathf.Clamp(LoadingProgressBar.GetComponent<Image>().fillAmount,0,_fillTarget);
    }
